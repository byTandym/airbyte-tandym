...
import pytest
from source_rutter.source import RutterStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RutterStream, "path", "v0/example_endpoint")
    mocker.patch.object(RutterStream, "primary_key", "test_primary_key")
    mocker.patch.object(RutterStream, "__abstractmethods__", set())
