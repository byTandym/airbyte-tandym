...
import pytest
from source_canopy.source import CanopyStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CanopyStream, "path", "v0/example_endpoint")
    mocker.patch.object(CanopyStream, "primary_key", "test_primary_key")
    mocker.patch.object(CanopyStream, "__abstractmethods__", set())
